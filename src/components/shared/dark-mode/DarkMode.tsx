  ...
  return (
    <label className="inline-flex items-center relative">
      ...
      <svg
        ...
        className="fill-white peer-checked:opacity-60 absolute w-[14px] h-[14px] start-[10px]"
      >
      ...
      <svg
        ...
        id="Layer_1"
        xmlns="http://www.w3.org/2000/svg"
        className="fill-black opacity-60 peer-checked:opacity-70 peer-checked:fill-white absolute w-[14px] h-[14px] end-[12px]"
      >
