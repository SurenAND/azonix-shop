          ...
          <div className="py-10 ps-5 bg-gradient-to-br from-axYellow to-axYellow/90 text-white rounded-3xl relative h-[320px] flex items-end">
            <div>
              ...
              <Image
                src={Image2}
                alt={t("gadget")}
                className="w-[320px] absolute top-0 -end-7 sm:end-0"
              />
            </div>
          </div>

          {/* third col */}
          <div className="sm:col-span-2 py-10 ps-5 bg-gradient-to-br from-primary to-primary/90 text-white rounded-3xl relative h-[320px] flex items-end">
            <div>
              <div className="mb-2">
                <p className="mb-2 text-white">{t("enjoy")}</p>
                <p className="text-2xl font-semibold mb-2">{t("with")}</p>
              ...
              <Image
                src={Image3}
                alt={t("laptop")}
                className="w-[300px] sm:w-[420px] absolute top-1/2 -translate-y-1/2 -end-0"
              />
            </div>
          </div>
        </div>
